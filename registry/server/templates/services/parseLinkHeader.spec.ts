...
describe('parseLinkHeader', () => {
    ...
    it('should correctly parse link with multiple arguments', () => {
        const parsedLink = parseLinkHeader('https://example.com/static/main.js; rel=script; crossorigin=anonymous,https://example.com/static/main.css;rel=stylesheet;priority=4000');
    ...
    it('should skip absent rel attribute', () => {
        const parsedLink = parseLinkHeader('https://example.com/static/main.js; crossorigin=anonymous,https://example.com/static/main.css;rel=stylesheet;priority=4000');
    ...
    it('should not parse link query params', () => {
        const parsedLink = parseLinkHeader('<https://api.github.com/user/9287/repos?page=3&per_page=100>; rel="next", ' + 
