...
const examples = {
    ...
    delete: async () => {
        await request.delete(`/api/v1/app/${examples.encodedName}`);
    },
};
examples.encodedName = encodeURIComponent(examples.correct.name);

describe('Tests /api/v1/app', () => {
    before('should work simple "create" and "delete"', async () => {
        await request.post('/api/v1/app').send(examples.correct).expect(200)
        await request.get(`/api/v1/app/${examples.encodedName}`).expect(200);
        await request.delete(`/api/v1/app/${examples.encodedName}`).expect(204);
        await request.get(`/api/v1/app/${examples.encodedName}`).expect(404);
    });
    ...
    describe('Create', () => {
        ...
        it('should not create record with incorrect type of field: spaBundle', async () => {
            ...
            response = await request.get(`/api/v1/app/${examples.encodedName}`)
            .expect(404, 'Not found');
    ...
    describe('Read', () => {
        ...
        it('should successfully return record', async () => {
            ...
            const response = await request.get(`/api/v1/app/${examples.encodedName}`)
            .expect(200);
    ...
    describe('Update', () => {
        ...
        it('should not update record if forbidden "name" is passed', async () => {
            ...
            const response = await request.put(`/api/v1/app/${examples.encodedName}`)
    ...
    describe('Delete', () => {
        ...
        it('should successfully delete record', async () => {
            ...
            const response = await request.delete(`/api/v1/app/${examples.encodedName}`)
            .expect(204, '');
