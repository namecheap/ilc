...
const resources = [
    `http-get://localhost:${appPorts.navigation}`,
    `http-get://localhost:${appPorts.people}`,
    `http-get://localhost:${appPorts.planets}`,
    `http-get://localhost:${appPorts.news}/_spa/dev/assets-discovery`,
    `http-get://localhost:${appPorts.system}/index.js`,
    `http-get://localhost:${appPorts.fetchWithCache}`,
    `http-get://localhost:${appPorts.ilc}/ping`,
    `http-get://localhost:${appPorts.registry}/ping`,
    `http-get://localhost:${appPorts.wrapper}/client-entry.js`,
];
