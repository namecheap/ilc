...
[![Demo website](./assets/demo-website.svg)](http://demo.microfrontends.online/)
...
* 🗄 **Built-in registry** - add new apps, pages or change configs and templates in few clicks. [More info here](registry.md).
* ⚡️ **Built for speed** - server side part of the system adds just ~17ms of latency
* 👨‍💻 **Develop right at production** - [Doc](develop_at_production.md)
* 🌐 **Internationalization support** - it is ready to serve your clients from any country.
[Doc](i18n.md), [Demo with localized navbar](http://demo.microfrontends.online/ua/)
* 📡 **Other advanced features:**
    * [Parcels](parcels.md)
    * [Plugins](https://github.com/namecheap/ilc-plugins-sdk)
    * [App Wrappers](app_wrappers.md)
...
1. Get familiar with [Installation guide](installation_guide.md)
...
And don't miss the **[Step-By-Step lessons about apps development with ILC](stepbystep/)**.

## Architecture overview

![ILC Architecture overview](./assets/ILC-Architecture.svg)
