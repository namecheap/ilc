...
describe('filter headers', () => {
    ...
    it('should return only accepted and x-forwarded headers', () => {
        ...
        chai.expect(filterHeaders(attributes, request)).to.be.eql({
            ...
            'x-request-brand': request.headers['x-request-brand'],
            'x-request-geo': request.headers['x-request-geo'],
            'z-is-audience': request.headers['z-is-audience'],
