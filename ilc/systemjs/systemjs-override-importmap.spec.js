...
const imports = {
    ...
    'named-define-with-dependencies': 'http://localhost:9876/base/systemjs/spec/fixtures/named-define-with-dependencies.js',
};
...
describe('systemjs override import map', () => {
    ...
    it('should resolve named module', async () => {
        expect(await window.System.import('anonymous-define'))
            .to.be.eql({ hi: 'from anonymous defined module' });
    });
    ...
    it('should override named module before first resolve', async () => {
        ...
        expect(await window.System.import(moduleId))
            .to.be.eql({ hi: 'from named defined dependency module' });
    });
